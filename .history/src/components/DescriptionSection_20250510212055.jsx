...
const DescriptionSection = () => {
  return (
    <section className="p-6">
      <h2 className="text-xl font-medium mb-4 border-b-2 inline-block">Description</h2>
      <p className="mb-4">
