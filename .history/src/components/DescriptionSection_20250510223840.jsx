    ...
    <>
      ...
      <style jsx>{`
        ...
        .banner-container {
          position: relative;
          width: 100vw;
          height: 400px; /* Adjust this height to crop the video */
          overflow: hidden;
        }
        ...
        .banner-video {
          ...
          width: 100%;
          height: 100%;
          object-fit: cover; /* Crop video while maintaining aspect ratio */
          object-position: center top; /* Crop the top part of the video */
        }
